...
#define  IPU_2BIT_BIT_1				0x1f4
#define  IPU_2BIT_BIT_0				0x1f8
#define  IPU_2BIT_MASK				0x1fc
...
#define OUT_FMT_ARGB				( 8 <<	OUT_FMT_BIT )
#define OUT_FMT_ARBG				( 9 <<	OUT_FMT_BIT )
#define OUT_FMT_AGRB				( 0xa <<  OUT_FMT_BIT )
#define OUT_FMT_AGBR				( 0xb <<  OUT_FMT_BIT )
#define OUT_FMT_ABRG				( 0xc <<  OUT_FMT_BIT )
#define OUT_FMT_ABGR				( 0xd <<  OUT_FMT_BIT )
#define OUT_FMT_RGBA				( 0xe <<  OUT_FMT_BIT )
#define OUT_FMT_RBGA				( 0x10 <<  OUT_FMT_BIT )
#define OUT_FMT_GRBA				( 0x11 <<  OUT_FMT_BIT )
#define OUT_FMT_GBRA				( 0x12 <<  OUT_FMT_BIT )
#define OUT_FMT_BRGA				( 0x13 <<  OUT_FMT_BIT )
#define OUT_FMT_BGRA				( 0x14 <<  OUT_FMT_BIT )
