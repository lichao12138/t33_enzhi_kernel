...
#define INGENIC_RTC_READ_TIME_MS 	_IOWR(RTC_CMD_BASE, 10u, int)
#define INGENIC_RTC_ALARM_MS 		_IOWR(RTC_CMD_BASE, 11u, struct set_reg)
#define INGENIC_IS_ALARM_ENABLE 	_IOWR(RTC_CMD_BASE, 12u, int)
