...
struct platform_device *pdev_edw = NULL;
#endif
...
#ifdef CONFIG_USB_DWC2_INGENIC_PM
extern char ingenic_usb_pm_buf[];
#endif
...
#ifdef CONFIG_USB_DWC2_INGENIC_PM
	sprintf(ingenic_usb_pm_buf, "%s", "suspend");
#endif
	return 0;
}

int dwc2_jz_resume(struct platform_device *pdev)
{
#ifndef  CONFIG_BOARD_HAS_NO_DETE_FACILITY
	struct dwc2_jz	*jz = platform_get_drvdata(pdev);
