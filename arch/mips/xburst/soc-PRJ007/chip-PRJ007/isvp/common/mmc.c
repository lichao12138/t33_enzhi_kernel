...
struct jz_sdhci_platdata jz_mmc0_pdata = {
	...
	.voltage_switch_gpio			= GPIO_MMC_VOLTAGE,
	.voltage_switch_gpio_invert		= GPIO_MMC_VOLTAGE_LEVEL,
	.max_width	            = 4,
	//.host_caps	            = (MMC_CAP_4_BIT_DATA | MMC_CAP_UHS_DDR50),
	.host_caps	            = (MMC_CAP_4_BIT_DATA | MMC_CAP_MMC_HIGHSPEED | MMC_CAP_SD_HIGHSPEED),
	//.host_caps2				= MMC_CAP2_HS200,
	...
	.rx_sel                 = TUNING_RX_SEL_0, //DDR50 need 45°
};
#endif
