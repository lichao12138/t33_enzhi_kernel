...
#define _RTP(NAME) JZDMA_REQ_##NAME = JZDMA_REQ_##NAME##_TX
	...
	_RTP(SSI0),
	_RTP(SSLV),
	JZDMA_REQ_AES0 = JZDMA_REQ_AES0_TX,
	JZDMA_REQ_AES1 = JZDMA_REQ_AES1_TX,
	JZDMA_REQ_HASH = JZDMA_REQ_HASH_TX,
	_RTP(I2C0),
	_RTP(I2C1),
	_RTP(I2C2),
	TYPE_MASK = 0xffff,
