...
#define GPIO_I2C3_SDA GPIO_PB(29)
#define GPIO_I2C3_SCK GPIO_PB(30)
#endif
/* ************************ Software I2C GPIO END *************************** */
...
#define GPIO_MMC_CD_N			GPIO_PB(28)
#define GPIO_MMC_CD_N_LEVEL		LOW_ENABLE
#define GPIO_MMC_PWR			GPIO_PB(27)
#define GPIO_MMC_PWR_LEVEL		LOW_ENABLE
#define GPIO_MMC_VOLTAGE		GPIO_PA(17)
#define GPIO_MMC_VOLTAGE_LEVEL	HIGH_ENABLE
