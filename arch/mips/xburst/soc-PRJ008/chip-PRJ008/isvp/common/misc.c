...
#endif
#ifdef CONFIG_SFC0
struct jz_sfc_info sfc0_info_cfg = {
#ifdef CONFIG_SFC0_V2_NORFLASH
	.spiflash_type = 0,
#elif defined CONFIG_SFC0_V2_NANDFLASH
	.spiflash_type = 1,
#else
	.spiflash_type = -1,
#endif
...
#endif
#ifdef CONFIG_SFC1
struct jz_sfc_info sfc1_info_cfg = {
#ifdef CONFIG_SFC1_V2_NORFLASH
	.spiflash_type = 0,
#elif defined CONFIG_SFC1_V2_NANDFLASH
	.spiflash_type = 1,
#else
	.spiflash_type = -1,
#endif
